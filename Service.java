    ...
    public void unicastMessage(int senderDeviceId, int recipientDeviceId, String privateMessage) {
        ...
        if (recipientIpAddress != null) {
            try {
               ...
               /*  PrintStream output = new PrintStream(recipient.getOutputStream());
                output.println(String.valueOf(senderDeviceId) + ": " + privateMessage);*/

                PrintWriter pw = new PrintWriter(recipient.getOutputStream(), true);
                pw.println(String.valueOf(senderDeviceId) + ": " + privateMessage +"\n");
